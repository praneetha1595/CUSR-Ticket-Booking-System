...
<li class="tab-item"><a href="/logout">logout</a></li>
	...
	<div class="main-agileinfo">
		<div class="sap_tabs">			
			...
			<form  action="/cancelTicket"  method="POST" id="bookTicket"> 
			  <input type="text" style="display:block;" id="allbookinglist" name="allbookinglist" value="" required> </input> 
			  
			  
			  <input type="submit" value="Cancel Train">
			  </form>
               <li>
              <c:forEach items="${allbookinglist.map}" var="mapList" varStatus="itr">
                <h2> <c:out value="${mapList.key.itenary}" /></h2>
          ...
          <table>
                ...
                <c:forEach items="${mapList.value}" var="itemList" varStatus="itr">
				...
				<td><c:out value="${itemList.bookingStatus}" /></td>
