...
<li class="tab-item"><a href="/logout">logout</a></li>
	...
	<div class="main-agileinfo">
		<div class="sap_tabs">			
            ...
            <label>
              Train Number<span class="req">*</span>
            </label>
            <input id="trainId" name="trainId" type="text" pattern="(SB|NB)[0-9]{4}" title="train number example SB645 " required />
          </div>
           <div class="field-wrap">
            <label>
              Trip Date<span class="req">*</span>
            </label>
           <input  id="tripDate" name="tripDate" type="text" value="mm/dd/yyyy" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required>
         
          </div>
          
          <button  type="submit" class="button button-block">Train Cancel</button>
                </form> 
